...
interface UnhandledTableHeadProps {
  selectedSubjectMatter: string,
  order: any,
  orderBy: any,
...
class UnhandledTableHead extends React.Component<UnhandledTableHeadProps> {
...
interface UnhandledTableProps {
  classes: any,
  data: any,
  selectedSubjectMatter: string
}

class UnhandledTable extends React.Component<UnhandledTableProps> {
  state = {
    order: 'desc',
    orderBy: 'occurrences',
    page: 0,
