...
import { saveFeedbackInput } from './ducks/feedbackInputSlice'
        ...
        return (
            <>
                {!this.state.isSubmitted ? (
                            ...
                            <FormControl component={'fieldset' as any}>
                                <FormGroup>
                                    {feedbackInputs.feedbackList
                                        ? feedbackInputs.feedbackList.map(
                                              choice => {
                                                  return (
                                                      <FormControlLabel
                                                          key={choice.value}
                                    ...
                                    <TextField
                                        ...
                                        onChange={e => {
                                            ...
                                            this.setState(prevState => ({
                                                ...prevState,
                                                feedbackComment: newValue,
                                            }))
                                        }}
                                        InputProps={{
                                            classes: {
                                                inputMultiline: this.props
                        ...
                        <CardActions>
                            <Button
                                ...
                                disabled={
                                    !(
                                        (!!feedbackInputs.feedbackList &&
                                            feedbackInputs.feedbackList.length >
                                                0 &&
                                            !every(
                                                feedbackInputs.feedbackList,
                                                x => !x.checked
                    ...
                    <CardContent>
                        Thank you. Your feedback is important to us and will
                        help improve Gen.
                    </CardContent>
                )}
            </>
...
export default withStyles(styles as any)(
    connect(mapStateToProps, mapDispatchToProps)(FeedbackInput)
)
