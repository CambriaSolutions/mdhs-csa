    ...
    render() {
        ...
        return (
            <Container theme={theme}>
                <BotAvatar
                    alt={title}
                    src={(mediaRoot || '').concat(chatbotAvatar)}
                />
...
const mapDispatchToProps = dispatch => ({
    ...
    sendQuickReply: (message: string, isEvent?: boolean) =>
        dispatch(sendQuickReply(message, isEvent)),
})
