...
const Container = styled.div`
    ...
    height: min-content;
    align-items: ${(p: any) =>
        p.entity === 'user' ? 'flex-end' : 'flex-start'};
    scroll-margin: 15px;
    p,
    div {
        font-size: 14px;
...
class Message extends Component<any> {
    ...
    render() {
        ...
        if (isToday) {
            ...
            formattedTimestamp = `Yesterday ${format(
                parsedTimestamp,
                'h:mm aa'
            )}`
        } else {
        ...
        const delayedResponseMessage =
            'Thank you for your patience, I’m working hard to get you the best answer. Hold tight!'
