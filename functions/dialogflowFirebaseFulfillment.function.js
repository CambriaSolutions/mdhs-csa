  ...
  .https.onRequest((request, response) => {
    ...
    const yesChildSupport = async agent => {
      try {
        ...
        await agent.add(
          `By clicking "I Acknowledge" below you are acknowledging receipt and understanding of these statements and the MDHS Website Disclaimers, Terms, and Conditions found here, and that you wish to continue.`
        )
