 ...
 * @param {*} agent
 */
export const enforcementRoot = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementLicenseSuspensionReinstatement = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementLicenseSuspension = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementLicenseSuspensionNonCompliance = async agent => {
  try {
    await agent.add(
      'Generally, after 30 days of non-payment a license suspension notice will automatically be sent to the parent who owes support. The parent who owes support has 90 days to become current or enter into a payment arrangement to avoid suspension. If the parent who owes support does not comply, the license is subject to suspension.'
    )
 ...
 * @param {*} agent
 */
export const enforcementLicenseReinstatement = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementTaxOffset = async agent => {
  try {
    await agent.add(
...
// Q1
export const enforcementTaxOffsetQ1 = async agent => {
  try {
    await agent.add(
...
// Q2/Q3
export const enforcementTaxOffsetQ2Q3 = async agent => {
  try {
    await agent.add(
...
// Q4
export const enforcementTaxOffsetQ4 = async agent => {
  try {
    await agent.add(
...
// Q5
export const enforcementTaxOffsetQ5 = async agent => {
  try {
    await agent.add(
...
// Q6
export const enforcementTaxOffsetQ6 = async agent => {
  try {
    await agent.add(
...
// Q7
export const enforcementTaxOffsetQ7 = async agent => {
  try {
    await agent.add(
...
// Q8
export const enforcementTaxOffsetQ8 = async agent => {
  try {
    await agent.add(
...
// Q9
export const enforcementTaxOffsetQ9 = async agent => {
  try {
    await agent.add(
...
// Q10
export const enforcementTaxOffsetQ10 = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementLiens = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementContestLien = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementFinancialAccountUpdateCase = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementPersonalInjury = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementSettlementsUpdateCase = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementPassportRevocation = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementPassportReinstatement = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementCreditBureauReporting = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementUnemployment = async agent => {
  try {
    await agent.add(
...
export const enforcementSettlementsNoUpdateCase = async agent => {
  try {
    await handleEndConversation(agent)
  } catch (err) {
    console.error(err.message, err)
 ...
 * @param {*} agent
 */
export const enforcementReportError = async agent => {
  try {
    await agent.add(
...
export const enforcementSubmitInquiry = async agent => {
  try {
 ...
 * @param {*} agent
 */
export const enforcementBankruptcy = async agent => {
  try {
    await agent.add(
 ...
 * @param {*} agent
 */
export const enforcementContempt = async agent => {
  try {
    await agent.add(
