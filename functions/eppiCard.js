...
exports.eppiFAQ = async agent => {
  try {
    await agent.add(
      `You may find answers to frequently asked questions about the Debit Card/EppiCard (<a href="https://www.eppicard.com/FAQ.html">https://www.eppicard.com/FAQ.html</a>), or ask me your Debit Card/EppiCard questions below.`
    )
  } catch (err) {
    console.log(err)
  }
