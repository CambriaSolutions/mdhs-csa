...
exports.enforcementLicenseSuspension = async agent => {
  try {
    ...
    await agent.add(
      'If the parent who owes support previously entered into a <u>court-approved</u> payment arrangement and fails to make payments in accordance with that arrangement, a notice is not required and the 90 days does not apply. The license is subject to immediate suspension.'
    )
